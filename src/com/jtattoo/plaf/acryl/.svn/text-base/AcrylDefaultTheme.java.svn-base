...
public class AcrylDefaultTheme extends BaseTheme {
    ...
    public static void setUp() {
        ...
        windowInactiveTitleBackgroundColor = new ColorUIResource(ColorHelper.brighter(windowTitleBackgroundColor, 10));
...
//        INACTIVE_COLORS = ColorHelper.createColorArr(topHi, topLo, 20);
        ...
        topLo = ColorHelper.brighter(windowInactiveTitleColorLight, 30);
