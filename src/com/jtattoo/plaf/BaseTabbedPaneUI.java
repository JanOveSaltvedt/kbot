...
//    }
    ...
    protected Color getSelectedBorderColor() {
        return getLoBorderColor();
    }

    protected Color getLoBorderColor() {
        return AbstractLookAndFeel.getControlDarkShadow();
    }

    protected Color getHiBorderColor() {
    ...
    protected void paintRoundedTopTabBorder(int tabIndex, Graphics g, int x1, int y1, int x2, int y2, boolean isSelected) {
        ...
        Color borderColor = getLoBorderColor();
        if (isSelected) {
    ...
    protected void paintTopTabBorder(int tabIndex, Graphics g, int x1, int y1, int x2, int y2, boolean isSelected) {
        ...
        Color loColor = getLoBorderColor();
        Color hiColor = getHiBorderColor();
            ...
            switch (tabPlacement) {
                case TOP: {
                    ...
                    if (tabPane.getBorder() != null) {
                        ...
                        g.drawRect(x, y + tabAreaHeight, x + w - 1, h - tabAreaHeight - 1);
                    }
                    break;
                }
                case LEFT: {
    ...
    public class ArrowButton extends JButton implements SwingConstants {
        ...
        public ArrowButton(int direction) {
            ...
            if (simpleButtonBorder) {
                setBorder(BorderFactory.createEtchedBorder(AbstractLookAndFeel.getControlHighlight(), AbstractLookAndFeel.getControlDarkShadow()));
            }
        }
